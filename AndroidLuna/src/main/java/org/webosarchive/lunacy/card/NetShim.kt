 ...
 * (measured with Workbench/probe 0.0.7, Workbench/results/touchpad-net.txt). One per window.
 */
class NetShim(
    ...
    companion object {
         ...
         * TouchPad, for synchronous and asynchronous requests alike (Workbench/probe 0.0.9). A
