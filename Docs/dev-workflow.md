...
| `AndroidLuna/local-assets/` | Stock Enyo 1.0 with those patches applied, Mojo and the other frameworks, and third-party test apps (Enyo samples, settings apps not yet shipped), populated by `AndroidLuna/fetch-assets.sh` | no |
