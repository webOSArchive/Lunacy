...
// header, and the device's cookie jar (measured with Workbench/probe 0.0.7, see
// Workbench/results/touchpad-net.txt). Here pages live on https origins, so XMLHttpRequest is
