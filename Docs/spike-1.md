...
The spike's own app has been removed: `AndroidLuna/` superseded it, and this page is the
record of what it measured. Screenshots and logs stay local.
...
A probe app, `Workbench/probe`, was installed on a real TouchPad running webOS CE 3.1.0. It
